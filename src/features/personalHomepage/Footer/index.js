    ...
    return (
        <>
            <Container>
                ...
                <FooterText>I’m always open to new projects whenever I have the time. If you have a website or dashboard in mind and need some help to make your ideas come to life, feel free to contact me ✌ </FooterText>
                <Wrapper>
                    <Link href={github}>
                    <GitHubIcon />
                    </Link>
